package com.xzc.lease.web.admin.controller.system;
...
import com.xzc.lease.web.admin.service.SystemPostService;
...
public class SystemUserController {
    ...
    public Result<IPage<SystemUserItemVo>> page(@RequestParam long current, @RequestParam long size, SystemUserQueryVo queryVo) {
        ...
        IPage<SystemUserItemVo> pageSUSer =  service.pageSUSer(systemUserItemVoPage,queryVo);
        return Result.ok(pageSUSer);
    }
